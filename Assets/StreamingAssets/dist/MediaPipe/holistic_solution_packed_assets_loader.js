...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME =
      'blaze-out/k8-opt/genfiles/third_party/mediapipe/web/solutions/holistic/holistic_solution_packed_assets.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](
          'datafile_blaze-out/k8-opt/genfiles/third_party/mediapipe/web/solutions/holistic/holistic_solution_packed_assets.data'
        );
      }
  ...
  loadPackage({
    files: [
      {
        filename:
          '/third_party/mediapipe/modules/pose_detection/pose_detection.tflite',
        start: 0,
        end: 2962288,
        audio: 0,
      },
      ...
      {
        filename: '/third_party/mediapipe/modules/hand_landmark/handedness.txt',
        start: 7412800,
        end: 7412811,
        audio: 0,
      },
    ...
    remote_package_size: 16877755,
    package_uuid: 'ae959d57-f008-4fa8-81e3-d2180f7564f5',
  });
})();
